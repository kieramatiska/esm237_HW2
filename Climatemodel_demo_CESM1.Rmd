...
ncpath <- "/Users/kieramatiska/Desktop/Bren/ESM 237/HW2/esm237_HW2/"   # path (directory)
# ncpath <- "/Users/katiemunster/Desktop/ESM237/esm237_HW2/"
ncname_hist <- "tas_Amon_MIROC-ES2L_historical_r26i1p1f2_gn_185001-201412.nc"  # CESM1 filename
...
ggplot() +
  ...
  geom_smooth(data = yrclim, 
             ...
             se = FALSE,
             color = "darkred") +
  labs(title = "Past and Projected Temperature from Miroc-ES2L Scenario 585",
       x = "Year",
