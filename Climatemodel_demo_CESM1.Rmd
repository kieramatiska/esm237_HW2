...
ncname <- "tas_Amon_MIROC-ES2L_ssp585_r1i1p1f2_gn_201501-210012.nc"  # CESM1 filename
...
ggplot(yrclim, aes(dt, Tann-273.15))+geom_point()+labs(y="Florida Temperature", x="Year")+ geom_smooth(method="lm")
```
...
ncname1 <- "tas_Amon_CanESM5-CanOE_historical_r1i1p2f1_gn_185001-201412.nc"  # E3SM filename
ncname2 <- "tas_Amon_CanESM5-CanOE_historical_r1i1p2f1_gn_185001-201412.nc"  # E3SM filename
